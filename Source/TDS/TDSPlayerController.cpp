...
void ATDSPlayerController::SetupInputComponent()
{
	...
	InputComponent->BindTouch(EInputEvent::IE_Pressed, this, &ATDSPlayerController::OnTouchPressed);
	InputComponent->BindTouch(EInputEvent::IE_Released, this, &ATDSPlayerController::OnTouchReleased);
...
void ATDSPlayerController::OnTouchPressed(const ETouchIndex::Type FingerIndex, const FVector Location)
{
	bIsTouch = true;
	OnSetDestinationPressed();
}

void ATDSPlayerController::OnTouchReleased(const ETouchIndex::Type FingerIndex, const FVector Location)
{
	bIsTouch = false;
